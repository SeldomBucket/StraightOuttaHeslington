...
public class SomeDucksNPC extends NPC {
    ...
    public void action(GameWorld gameWorld) {
        ...
        Agent enemyDuck1 = new Agent("Some Duck", Agent.AgentType.ENEMY,new Statistics(10,500,8,2,3,3,3,3,3),emptyList,new CurrentEquipment(0,0,0,0,0),1);
        Agent enemyDuck2 = new Agent("Some Duck", Agent.AgentType.ENEMY,new Statistics(10,500,8,2,3,3,3,3,3),emptyList,new CurrentEquipment(0,0,0,0,0),1);
